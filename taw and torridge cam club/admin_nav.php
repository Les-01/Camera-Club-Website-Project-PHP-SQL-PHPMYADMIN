<html>
    ...
    <body>
        ...
        <section class="top-nav">        
            ...
            <ul class="menu">
                <li class="dropdown">
                        <a href="javascript:void(0)" class="dropbtn" style="color: red">Admin Functions</a>
                        <div class="dropdown-content">
                        <a href="memb_man.php" style="color: red">Member Management</style></a>
                        ...
                        <a href="comp_man.php" style="color: red">Competition Management</style></a>
                        </div>
                </li>          
                <li class="dropdown">
