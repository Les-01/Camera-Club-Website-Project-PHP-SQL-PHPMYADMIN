<?php
    ...
    if($_FILES["fileToUpload"]["size"] >= 1000000) 
    {
        ...
        $upLoadOK = 0;
        header("location: image_man.php?error=tobig");
    }
    ...
    //--------------------  Reference to 'adminimageUpload' function on 'functions.php'  --------------------
    adminimageUpload($conn, $image_name, $target_file, $varrand, $memId);