...
<html lang="en">
    ...
    ?>     
        <!--  Basic HTML  -->
        <h2>Charlie Chaplin Portfolio</h2>
        <div class="main">	
            <?php
                // SQL statement to select all images from the database 'taw_and_torridge_cam_club_db' table 'tbl_images' where the field member ID is equal to portfolio owners member ID.
                $sql = "SELECT * FROM `taw_and_torridge_cam_club_db`.`tbl_images` WHERE `fld_member_id` LIKE '65'";
