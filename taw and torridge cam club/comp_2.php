...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Night Sky Competition</title>
            ...
            <form action="vote_process.php" method="POST">
                <label for="comp_vote">Select Image:</label>
                    <select id="comp_vote" name="comp_vote">
                        <!--  SQL statement to select all images from the database 'taw_and_torridge_cam_club_db' table 'tbl_images' where the field competition ID is equal to the value of the variable '$varCompId'.  -->
