<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if (emptyInputSignUp($varfName, $varlName, $varaddress, $varphoneNum, $varemail, $varpassword, $varrepeatPassword) !== false) {
        ...
        createUserAccount($conn, $varfName, $varlName, $varaddress, $varphoneNum, $varemail, $varpassword);
    } 
