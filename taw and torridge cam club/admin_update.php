<?php
    ...
    // This 'IF' statement declares that if the user has used the 'submit' button to gain access to this process page then
    // execute the code within the if statement.
        if(isset($_POST['submit']))
        {
            ...
            //--------------------  Reference to 'adminUpdateUserAccount' function on 'functions.php'  --------------------  
            adminUpdateUserAccount($conn, $varmemId, $varfName, $varlName, $varaddress, $varphoneNum, $varemail, $varpassword, $varrank);
        } 

        // This 'IF' statement declares that if the user has used the 'del' button on the sign up form to gain access to this process page then
    // execute the code within the if statement.
        if(isset($_POST['del']))
        {       
            // This assigns the values POSTED to this page using '$_POST' method to the variables to be passed onto a function.
            ...
            //--------------------  Reference to 'adminDeleteUserAccount' function on 'functions.php'  --------------------  
            adminDeleteUserAccount($conn, $varmemId);
        }